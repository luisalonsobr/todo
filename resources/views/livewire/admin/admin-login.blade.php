<div>
    <x-guest-layout>
        <x-authentication-card>
            ...
            <div class="w-full text-center text-lg py-4">
                Painel de Controle
            </div>
            ...
            <form wire:submit="post" action="">
                ...
                <div class="mt-4">
                    ...
                    <x-input id="password" wire:model="password" class="block mt-1 w-full" type="password" name="password" required autocomplete="current-password" />
                </div>
